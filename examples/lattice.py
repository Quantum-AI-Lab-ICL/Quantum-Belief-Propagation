...
if __name__ == "__main__":
    ...
    b00 = propagator.mean_single_belief(0, 0)
    b01 = propagator.mean_single_belief(0, 1)
    b02 = propagator.mean_single_belief(0, 2)
    b10 = propagator.mean_single_belief(1, 0)
    b11 = propagator.mean_single_belief(1, 1)
